...
export const MetricCard = memo(function MetricCard({ label, score, max, description, icon }: MetricCardProps): JSX.Element {
  ...
  return (
    <div className="card p-4 sm:p-5">
      ...
      <div className="w-full bg-gray-100 dark:bg-gray-700 rounded-full h-2 mb-2" role="progressbar" aria-valuenow={score} aria-valuemin={0} aria-valuemax={max} aria-label={`${label}: ${score} of ${max}`}>
        <div
